...
const styles = StyleSheet.create({
  ...
  bannerTitle: { color: colors.dangerText, fontSize: 18, fontWeight: "600" },
  bannerSubtitle: { color: colors.danger, fontSize: 14, marginTop: spacing.xs },
  ...
  missedLabel: { color: colors.textSecondary, fontSize: 12, marginBottom: spacing.sm },
  missedItem: { color: colors.danger, fontSize: 13, marginBottom: 4 },
  resetWrap: { alignItems: "center", marginBottom: spacing.lg },
  resetLabel: { color: colors.textMuted, fontSize: 13 },
  resetValue: { color: colors.danger, fontSize: 34, fontWeight: "700" },
  resetTotal: { color: colors.textMuted, fontSize: 16 },
  button: { backgroundColor: colors.danger, borderRadius: radius.md, paddingVertical: 14, alignItems: "center" },
  buttonText: { color: colors.dangerBg, fontSize: 14, fontWeight: "600" },
  bestRun: { color: colors.textMuted, fontSize: 12, textAlign: "center", marginTop: spacing.md },
});
